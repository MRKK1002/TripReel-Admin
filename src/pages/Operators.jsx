...
const STATE_COLORS = {
  ...
  KYC_VERIFICATION: "bg-yellow-100 text-yellow-700",
  COMMERCIAL_CONTRACT_SENT: "bg-orange-100 text-orange-700",
  CONTRACT_SIGNED: "bg-purple-100 text-purple-700",
  RAZORPAY_LINKED_ACCOUNT_CREATED: "bg-indigo-100 text-indigo-700",
  TRAINING_COMPLETED: "bg-cyan-100 text-cyan-700",
  TEST_LISTING_PUBLISHED: "bg-teal-100 text-teal-700",
  ACTIVE_PROBATION: "bg-lime-100 text-lime-700",
  ACTIVE_FULL: "bg-green-100 text-green-700",
  SUSPENDED: "bg-red-100 text-red-700",
  OFFBOARDED: "bg-slate-100 text-slate-700",
};
  ...
  return (
    <span
      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
        STATE_COLORS[state] || "bg-gray-100 text-gray-700"
      }`}
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">
            {total} operator{total !== 1 ? "s" : ""} registered
          </p>
        </div>
      </div>
